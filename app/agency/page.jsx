    ...
    <main style={{ minHeight: "100vh", background: "#060a07", fontFamily: "'Plus Jakarta Sans', 'Inter', sans-serif", color: "#d1e0d6" }}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .health-wrap{margin-bottom:1rem;}
        .health-top{display:flex;justify-content:space-between;font-size:0.7rem;margin-bottom:0.3rem;font-family:'Inter',sans-serif;}
        .health-lbl{color:#2a3d2e;font-weight:500;}
        .health-bar{height:4px;background:rgba(255,255,255,0.04);border-radius:100px;overflow:hidden;}
        .health-fill{height:100%;border-radius:100px;transition:width 0.4s;}
        .score-row{display:grid;grid-template-columns:repeat(4,1fr);gap:0.5rem;margin-bottom:1rem;}
        .score-box{background:#080c09;border:1px solid rgba(255,255,255,0.03);border-radius:9px;padding:0.55rem 0.4rem;text-align:center;}
        .score-val{font-family:'Plus Jakarta Sans',sans-serif;font-size:1rem;font-weight:800;line-height:1;}
        .score-lbl{font-size:0.58rem;color:#2a3d2e;text-transform:uppercase;letter-spacing:0.08em;margin-top:0.2rem;font-family:'Inter',sans-serif;font-weight:600;}
        .platforms-row{display:flex;gap:0.3rem;margin-bottom:0.75rem;flex-wrap:wrap;}
        .platform-tag{font-size:0.66rem;padding:0.15rem 0.45rem;border-radius:5px;background:rgba(34,201,122,0.04);border:1px solid rgba(34,201,122,0.1);color:#3d5240;font-family:'Inter',sans-serif;}
        .auto-row{display:flex;gap:0.4rem;flex-wrap:wrap;margin-bottom:0.5rem;}
        .auto-tag{display:inline-flex;align-items:center;gap:0.25rem;font-size:0.65rem;font-weight:600;padding:0.15rem 0.5rem;border-radius:5px;font-family:'Inter',sans-serif;}
        ...
        .notes-box{background:#080c09;border:1px solid rgba(255,255,255,0.03);border-radius:8px;padding:0.65rem 0.75rem;font-size:0.78rem;color:#3d5240;line-height:1.5;font-family:'Inter',sans-serif;}
        ...
        .rev-lbl{font-size:0.68rem;color:#3d5240;margin-top:0.3rem;text-transform:uppercase;letter-spacing:0.08em;font-family:'Inter',sans-serif;font-weight:600;}
        .rev-sub{font-size:0.7rem;color:#1e2e22;margin-top:0.15rem;font-family:'Inter',sans-serif;}
        .rev-section{background:linear-gradient(145deg,#0c1510,#0a120d);border:1px solid rgba(255,255,255,0.04);border-radius:14px;padding:1.5rem;margin-bottom:1rem;}
        .rev-section-title{font-family:'Plus Jakarta Sans',sans-serif;font-size:0.95rem;font-weight:700;color:#c4d4c8;margin-bottom:1.25rem;}
        .rev-client-row{display:flex;align-items:center;gap:0.75rem;padding:0.7rem 0;border-bottom:1px solid rgba(255,255,255,0.03);}
        .rev-client-row:last-child{border-bottom:none;}
        .rev-client-avatar{width:32px;height:32px;background:linear-gradient(135deg,rgba(34,201,122,0.1),rgba(34,201,122,0.03));border:1px solid rgba(34,201,122,0.12);border-radius:8px;display:flex;align-items:center;justify-content:center;font-family:'Plus Jakarta Sans',sans-serif;font-weight:800;color:#22c97a;font-size:0.8rem;flex-shrink:0;}
        .rev-client-info{flex:1;min-width:0;}
        .rev-client-name{font-family:'Plus Jakarta Sans',sans-serif;font-size:0.84rem;font-weight:700;color:#e2ede7;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
        .rev-client-tier{font-size:0.68rem;color:#3d5240;font-family:'Inter',sans-serif;}
        .rev-client-bar-wrap{flex:2;height:6px;background:rgba(255,255,255,0.03);border-radius:100px;overflow:hidden;}
        .rev-client-bar{height:100%;border-radius:100px;background:linear-gradient(90deg,#22c97a,#0d9456);}
        .rev-client-mrr{font-family:'Plus Jakarta Sans',sans-serif;font-size:0.85rem;font-weight:800;color:#22c97a;min-width:70px;text-align:right;}
        .tier-row{display:flex;align-items:center;gap:0.75rem;padding:0.65rem 0;border-bottom:1px solid rgba(255,255,255,0.03);}
        .tier-row:last-child{border-bottom:none;}
        .tier-dot{width:10px;height:10px;border-radius:50%;flex-shrink:0;}
        .tier-name{font-size:0.84rem;color:#c4d4c8;font-family:'Plus Jakarta Sans',sans-serif;font-weight:600;min-width:80px;}
        .tier-clients{font-size:0.75rem;color:#3d5240;font-family:'Inter',sans-serif;min-width:60px;}
        .tier-bar-wrap{flex:1;height:6px;background:rgba(255,255,255,0.03);border-radius:100px;overflow:hidden;}
        .tier-bar{height:100%;border-radius:100px;}
        .tier-mrr{font-family:'Plus Jakarta Sans',sans-serif;font-size:0.85rem;font-weight:800;color:#22c97a;min-width:70px;text-align:right;}
        .risk-card{background:#080c09;border:1px solid rgba(239,68,68,0.1);border-radius:10px;padding:0.875rem 1rem;margin-bottom:0.5rem;display:flex;align-items:center;justify-content:space-between;}
        .risk-info{display:flex;align-items:center;gap:0.6rem;}
        .risk-avatar{width:30px;height:30px;background:rgba(239,68,68,0.08);border:1px solid rgba(239,68,68,0.15);border-radius:8px;display:flex;align-items:center;justify-content:center;font-family:'Plus Jakarta Sans',sans-serif;font-weight:800;color:#f87171;font-size:0.75rem;}
        ...
        .modal-sub{font-size:0.82rem;color:#3d5240;margin-bottom:1.75rem;font-family:'Inter',sans-serif;}
        .form-label{display:block;font-size:0.72rem;font-weight:700;color:#4d6b54;margin-bottom:0.4rem;letter-spacing:0.03em;text-transform:uppercase;font-family:'Inter',sans-serif;}
        ...
        .form-select{width:100%;background:#080c09;border:1px solid rgba(255,255,255,0.06);border-radius:10px;padding:0.75rem 1rem;color:#e2ede7;font-size:0.875rem;outline:none;font-family:'Inter',sans-serif;margin-bottom:1rem;}
        .form-textarea{width:100%;background:#080c09;border:1px solid rgba(255,255,255,0.06);border-radius:10px;padding:0.75rem 1rem;color:#e2ede7;font-size:0.875rem;outline:none;font-family:'Inter',sans-serif;margin-bottom:1rem;resize:vertical;min-height:80px;}
        .form-row{display:grid;grid-template-columns:1fr 1fr;gap:0.75rem;}
        .divider{border:none;border-top:1px solid rgba(255,255,255,0.04);margin:1rem 0;}
        .platforms-select{display:flex;gap:0.5rem;margin-bottom:1rem;flex-wrap:wrap;}
        .platform-toggle{background:transparent;border:1px solid rgba(255,255,255,0.06);color:#4d6b54;font-size:0.78rem;padding:0.4rem 0.85rem;border-radius:8px;cursor:pointer;font-family:'Inter',sans-serif;transition:all 0.15s;}
        .platform-toggle.selected{background:rgba(34,201,122,0.08);border-color:rgba(34,201,122,0.25);color:#22c97a;font-weight:600;}
        .health-input{width:100%;accent-color:#22c97a;margin-bottom:1rem;}
        .toggle-row{display:flex;align-items:center;justify-content:space-between;background:#080c09;border:1px solid rgba(255,255,255,0.04);border-radius:10px;padding:0.75rem 1rem;margin-bottom:1rem;}
        .toggle-label{font-size:0.82rem;color:#c4d4c8;font-family:'Inter',sans-serif;}
        .toggle-sub{font-size:0.7rem;color:#2a3d2e;margin-top:2px;font-family:'Inter',sans-serif;}
        .toggle-switch{width:40px;height:22px;background:rgba(255,255,255,0.06);border-radius:100px;position:relative;cursor:pointer;transition:background 0.2s;border:none;}
        ...
        .freq-btn{background:#080c09;border:1px solid rgba(255,255,255,0.06);color:#4d6b54;font-size:0.78rem;padding:0.6rem;border-radius:9px;cursor:pointer;font-family:'Inter',sans-serif;text-align:center;transition:all 0.15s;}
        .freq-btn.selected{background:rgba(34,201,122,0.08);border-color:rgba(34,201,122,0.25);color:#22c97a;font-weight:600;}
        .modal-btns{display:flex;gap:0.75rem;margin-top:0.5rem;}
        .modal-cancel{flex:1;background:transparent;border:1px solid rgba(255,255,255,0.06);color:#4d6b54;font-family:'Plus Jakarta Sans',sans-serif;font-weight:600;font-size:0.875rem;padding:0.75rem;border-radius:10px;cursor:pointer;}
        .modal-submit{flex:2;background:linear-gradient(135deg,#22c97a,#1aae6a);color:#071209;font-family:'Plus Jakarta Sans',sans-serif;font-weight:700;font-size:0.875rem;padding:0.75rem;border-radius:10px;border:none;cursor:pointer;box-shadow:0 2px 8px rgba(34,201,122,0.15);}
