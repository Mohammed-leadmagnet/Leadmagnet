    ...
    <main className="page-shell">
      ...
      <section className="auth-card">
        ...
        <p className="subtitle">
          Continue to your LeadMagnet dashboard to manage campaigns, leads,
          clients, reports, and follow-ups.
        </p>
        ...
        <div className="bottom">
          Don&apos;t have an account? <Link href="/signup">Start free trial</Link>
        </div>
      </section>
    </main>
  );
